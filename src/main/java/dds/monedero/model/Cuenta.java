...
public class Cuenta {
  ...
  public void poner(double cuanto) {
    ...
    new Movimiento(LocalDate.now(), cuanto, TipoMovimiento.DEPOSITO).agregateA(this);
  }
  ...
  public void sacar(double cuanto) {
    ...
    new Movimiento(LocalDate.now(), cuanto, TipoMovimiento.EXTRACCION).agregateA(this);
  }
